...
SWEP.Instructions = " They Can't kill the Boogeyman. (R+LMB to change mode to slash/stab. RMB to interact with environment.)"
...
SWEP.WorldModelExchange = "models/weapons/tfa_nmrih/w_me_kitknife.mdl"
