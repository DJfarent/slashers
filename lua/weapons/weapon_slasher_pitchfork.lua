...
SWEP.Instructions = "A pitchfork to go with that Rural look"
SWEP.Category = "Slasher weapons"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/weapons/pitchfork/w_pitchfork.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_fubar.mdl"
SWEP.WorldModelExchange = "models/weapons/pitchfork/w_pitchfork.mdl"
SWEP.ViewModel = ""
