...
local Slasher_phrases = {
	normal = {

		"slasher/Jason_Morph.ogg",
		"slasher/Jason_Breath_01.ogg",
	}
...
local leatherface_phrases = {
	normal = {
		"slasher/alert3.mp3",
		"slasher/combatidle4.mp3",
		"slasher/combatidle6.mp3",
		"slasher/pain1.mp3",
		"slasher/death1.mp3",
	}
...
local Ghost_phrases = {
	normal = {
		"slasher/sawrunner.wav",
		"slasher/sawrunner1.wav",
		"slasher/sawrunner2.wav",
		"slasher/sawrunner3.wav",
		"slasher/sawrunner4.wav",
		"slasher/sawrunner5.wav",

	}
}


local tommyjarvis_phrases = {
	normal = {
		"tommy/help.wav",
		"tommy/hell.wav",
		"tommy/getme.wav",
...
local function GetPlayerClassPhrases(ply, phraseType)
	...
	if playerClass == "Slasher" then
    if ply.SlasherType == "Leatherface" and leatherface_phrases[phraseType] then
        return leatherface_phrases[phraseType]
    elseif ply.SlasherType == "Michael" and Michael_phrases[phraseType] then
        return Michael_phrases[phraseType]
    elseif ply.SlasherType == "Ghost" and Ghost_phrases[phraseType] then
        return Ghost_phrases[phraseType]
    elseif ply.SlasherType == "Jason" and Jason_phrases[phraseType] then
        return Jason_phrases[phraseType]
    elseif Slasher_phrases[phraseType] then
        return Slasher_phrases[phraseType]
    end

	elseif playerClass == "tommyjarvis" and tommyjarvis_phrases[phraseType] then
		return tommyjarvis_phrases[phraseType]
...
net.Receive("hg_phrase", function(len, ply)
	...
	if playerClass == "Slasher" or playerClass == "tommyjarvis" or 
...
hook.Add("PreHomigradDamage","BurnScream", function( ent, dmgInfo )
	...
	and ply.organism and ply.PlayerClassName ~= "Slasher" and !ply.organism.otrub and ply:Alive() then
...
hook.Add("HarmDone", "MateDead", function(attacker, victim, amt)
	...
	if !(victimClass == "Slasher" or victimClass == "tommyjarvis" or 
...
hook.Add("HGReloading", "Perezaryad", function(wep)
	...
	local playerClass = ply.PlayerClassName
	if !(playerClass == "Slasher" or playerClass == "tommyjarvis" or playerClass == "swat") then return end
